...
public class PedidoDAO {
	...
	/*
	 * Precisamos mostrar o valor total dos pedidos e emprimir em uma tela
	 */
	...
	public Pedido buscarPedidoComCliente(Long id) {
		return em.createQuery("SELECT p FROM Pedido p JOIN FETCH p.cliente WHERE p.id = :id", Pedido.class).setParameter("id", id)
				.getSingleResult();
